                        ...
                        <div className="p-6 border border-border rounded-lg bg-card">
                            ...
                            <div className="grid gap-3">
                                <button className="p-4 text-left border border-border rounded-md hover:bg-muted transition-colors">
                                    <div className="font-medium">View Assigned Tasks</div>
                                    <div className="text-sm text-muted-foreground">See your current task assignments</div>
                                </button>
                                <button className="p-4 text-left border border-border rounded-md hover:bg-muted transition-colors">
                                    <div className="font-medium">Set Availability</div>
                                    <div className="text-sm text-muted-foreground">Update your work schedule</div>
                                </button>
                                <button className="p-4 text-left border border-border rounded-md hover:bg-muted transition-colors">
                                    <div className="font-medium">Task History</div>
